 ...
 */
package com.ruomm.springcloud.paymentserver.shiro.realm;

import com.ruomm.springcloud.paymentserver.shiro.model.User;
...
public class UserAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken)
		...
		if (null == authcToken){
			System.out.println("验证当前Subject时获取到token为：NULL");
		} else {
